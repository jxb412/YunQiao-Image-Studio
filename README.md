...
```text
https://github.com/jxb412/YunQiao-Image-Studio/releases/tag/v0.1.12
```

客户端文件：

- Windows x64 便携版：`YunQiao-Image-Studio-0.1.12-win-x64-portable.exe`
...
- 发布流程支持生成三端客户端清单，按当前系统匹配 Windows x64、macOS Intel x64、macOS Apple Silicon arm64。
- GitHub Release workflow 会生成带文件大小和 SHA256 的发布清单，并可部署到下载站目录。
